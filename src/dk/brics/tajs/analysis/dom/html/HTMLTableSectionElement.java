...
public class HTMLTableSectionElement {
	...
	public static void build(State s) {
		...
		createDOMInternalPrototype(s, TABLESECTION_PROTOTYPE, Value.makeObject(HTMLElement.ELEMENT_PROTOTYPE, new Dependency()));

		// Multiplied Object
		s.newObject(TABLESECTION);
		createDOMInternalPrototype(s, TABLESECTION, Value.makeObject(TABLESECTION_PROTOTYPE, new Dependency()));
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLTableSectionElement", Value.makeObject(TABLESECTION, new Dependency()));

		/*
		 * Properties.
		 */
		// DOM Level 1
		createDOMProperty(s, TABLESECTION, "align", Value.makeAnyStr(new Dependency()), DOMSpec.LEVEL_1);
		createDOMProperty(s, TABLESECTION, "ch", Value.makeAnyStr(new Dependency()), DOMSpec.LEVEL_1);
		createDOMProperty(s, TABLESECTION, "chOff", Value.makeAnyStr(new Dependency()), DOMSpec.LEVEL_1);
		createDOMProperty(s, TABLESECTION, "vAlign", Value.makeAnyStr(new Dependency()), DOMSpec.LEVEL_1);
		createDOMProperty(s, TABLESECTION, "rows", Value.makeObject(HTMLCollection.COLLECTION, new Dependency()).setReadOnly(), DOMSpec.LEVEL_1);
