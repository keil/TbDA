...
public class HTMLCanvasElement {
	...
	public static void build(State s) {
		...
		createDOMInternalPrototype(s, CANVAS_PROTOTYPE, Value.makeObject(HTMLElement.ELEMENT_PROTOTYPE, new Dependency()));
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLCanvasElement", Value.makeObject(CANVAS_PROTOTYPE, new Dependency()));

		// Multiplied Object
		s.newObject(CANVAS);
		createDOMInternalPrototype(s, CANVAS, Value.makeObject(CANVAS_PROTOTYPE, new Dependency()));
		 ...
		 * Properties.
		 */
		createDOMProperty(s, CANVAS_PROTOTYPE, "height", Value.makeAnyNumUInt(new Dependency()), DOMSpec.HTML5);
		createDOMProperty(s, CANVAS_PROTOTYPE, "width", Value.makeAnyNumUInt(new Dependency()), DOMSpec.HTML5);
	...
	public static Value evaluate(DOMObjects nativeObject, FunctionCalls.CallInfo call, State s, Solver.SolverInterface c) {
		...
		case HTMLCANVASELEMENT_GET_CONTEXT: {
			return Value.makeObject(CanvasRenderingContext2D.CONTEXT2D, new Dependency());
		}
		default: {
