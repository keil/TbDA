...
public class DOMCharacterData {
	...
	public static void build(State s) {
		...
		createDOMInternalPrototype(s, CHARACTER_DATA_PROTOTYPE, Value.makeObject(DOMNode.NODE_PROTOTYPE, new Dependency()));

		// Multiplied object.
		s.newObject(CHARACTER_DATA);
		createDOMInternalPrototype(s, CHARACTER_DATA, Value.makeObject(CHARACTER_DATA_PROTOTYPE, new Dependency()));
		createDOMProperty(s, DOMWindow.WINDOW, "CharacterData", Value.makeObject(CHARACTER_DATA, new Dependency()));

		/*
		 * Properties.
		 */
		// DOM Level 1
		createDOMProperty(s, CHARACTER_DATA, "data", Value.makeAnyStr(new Dependency()), DOMSpec.LEVEL_1);
		createDOMProperty(s, CHARACTER_DATA, "length", Value.makeAnyNumUInt(new Dependency()), DOMSpec.LEVEL_1);
