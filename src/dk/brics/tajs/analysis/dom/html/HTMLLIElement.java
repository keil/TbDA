...
public class HTMLLIElement {
	...
	public static void build(State s) {
		...
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLLIElement", Value.makeObject(CONSTRUCTOR, new Dependency(), new DependencyGraphReference()));
		...
		createDOMProperty(s, INSTANCES, "value", Value.makeAnyNum(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
