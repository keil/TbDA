...
public class HTMLBaseFontElement {
	...
	public static void build(State s) {
		...
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLBaseFontElement", Value.makeObject(CONSTRUCTOR, new Dependency(), new DependencyGraphReference()));
		 ...
		 */
		// DOM LEVEL 1
		createDOMProperty(s, INSTANCES, "color", Value.makeAnyStr(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
		createDOMProperty(s, INSTANCES, "face", Value.makeAnyStr(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
