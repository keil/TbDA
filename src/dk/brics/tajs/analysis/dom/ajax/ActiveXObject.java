...
public class ActiveXObject {
	...
	public static void build(State s) {
		...
		createDOMProperty(s, DOMWindow.WINDOW, "ActiveXObject", Value.makeObject(CONSTRUCTOR, new Dependency(), new DependencyGraphReference()));
		 ...
		 * Functions.
		 */
		createDOMFunction(s, PROTOTYPE, DOMObjects.ACTIVE_X_OBJECT_OPEN, "open", 5, DOMSpec.LEVEL_0);
		createDOMFunction(s, PROTOTYPE, DOMObjects.ACTIVE_X_OBJECT_SEND, "send", 1, DOMSpec.LEVEL_0);
		createDOMFunction(s, PROTOTYPE, DOMObjects.ACTIVE_X_OBJECT_SET_REQUEST_HEADER, "setRequestHeader", 2, DOMSpec.LEVEL_0);
		createDOMFunction(s, PROTOTYPE, DOMObjects.ACTIVE_X_OBJECT_ABORT, "abort", 0, DOMSpec.LEVEL_0);
		createDOMFunction(s, PROTOTYPE, DOMObjects.ACTIVE_X_OBJECT_GET_RESPONSE_HEADER, "getResponseHeader", 1, DOMSpec.LEVEL_0);
		createDOMFunction(s, PROTOTYPE, DOMObjects.ACTIVE_X_OBJECT_GET_ALL_RESPONSE_HEADERS, "getAllResponseHeaders", 0, DOMSpec.LEVEL_0);
