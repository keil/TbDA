...
public class HTMLHeadElement {
	...
	public static void build(State s) {
		...
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLHeadElement", Value.makeObject(CONSTRUCTOR, new Dependency(), new DependencyGraphReference()));
		 ...
		 */
		// DOM Level 1
		createDOMProperty(s, INSTANCES, "profile", Value.makeAnyStr(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
