...
Scheduler.prototype.schedule = function () {
  ...
  var temp = this.currentTcb;
  while (temp != null) {
  	assumeNonNullUndef("temp");
    if (temp.isHeldOrSuspended()) {
      temp = temp.link;
    } else {
...
Packet.prototype.addTo = function (queue) {
  ...
  assumeNonNullUndef("queue");
  var peek, next = queue;
  while ((peek = next.link) != null) {
    assumeNonNullUndef("peek");
    next = peek;
    }
  next.link = this;
  return queue;
