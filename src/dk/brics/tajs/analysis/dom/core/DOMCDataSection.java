...
public class DOMCDataSection {
	...
	public static void build(State s) {
		...
		createDOMInternalPrototype(s, CDATASECTION_PROTOTYPE, Value.makeObject(DOMText.TEXT_PROTOTYPE, new Dependency()));

		// Multiplied object
		s.newObject(CDATASECTION);
		createDOMInternalPrototype(s, CDATASECTION, Value.makeObject(CDATASECTION_PROTOTYPE, new Dependency()));
		createDOMProperty(s, DOMWindow.WINDOW, "CDataSection", Value.makeObject(CDATASECTION, new Dependency()));
