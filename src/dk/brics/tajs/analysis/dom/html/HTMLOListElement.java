...
public class HTMLOListElement {
	...
	public static void build(State s) {
		...
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLOListElement", Value.makeObject(CONSTRUCTOR, new Dependency(), new DependencyGraphReference()));
		 ...
		 */
		// DOM Level 1
		createDOMProperty(s, INSTANCES, "compact", Value.makeAnyBool(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
		createDOMProperty(s, INSTANCES, "start", Value.makeAnyNum(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
