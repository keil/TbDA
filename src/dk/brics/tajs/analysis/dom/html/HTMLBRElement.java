...
public class HTMLBRElement {
	...
	public static void build(State s) {
		...
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLBRElement", Value.makeObject(CONSTRUCTOR, new Dependency(), new DependencyGraphReference()));
		 ...
		 */
		// DOM LEVEL 1
		createDOMProperty(s, INSTANCES, "clear", Value.makeAnyStr(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
