...
/*
 * cmdatatagutils.js 
 * $Id: cmdatatagutils-MASTER.txt 125128 2009-07-27 15:53:03Z wbird $
 * $Revision: 125128 $
 *
 * Version 4.1.0
 *
 ...
 * WBIRD	7/27/09		currency code copied to attr1 of shop &order tags
 */
 
var cm_exAttr=new Array;  
var cm_ClientID = "90253055";
var cm_TrackLink = "A";
...
function cmCreateProductviewTag(productID, productName, categoryID,attributes) {
	...
	cmMakeTag(["tid","5","pi","PRODUCT: "+productName+" ("+productID+")","pr",productID,"pm",productName,"cg",categoryID,"pc","N","cm_vc",cmExtractParameter("cm_vc",document.location.href),"cm_exAttr",cm_exAttr]);
}
...
function cmCreateShopAction5Tag(productID,productName,productQuantity,productPrice,categoryID,currency,attributes) {
	...
	attributes=currency+"-_-"+attributes;
	if (attributes){
