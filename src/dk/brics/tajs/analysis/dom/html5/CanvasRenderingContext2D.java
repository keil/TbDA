...
public class CanvasRenderingContext2D {
	...
	public static ObjectLabel CONTEXT2D = new ObjectLabel(DOMObjects.CANVASRENDERINGCONTEXT2D, ObjectLabel.Kind.OBJECT);
	public static ObjectLabel CONTEXT2D_PROTOTYPE = new ObjectLabel(DOMObjects.CANVASRENDERINGCONTEXT2D_PROTOTYPE, ObjectLabel.Kind.OBJECT);

	public static ObjectLabel GRADIENT = new ObjectLabel(DOMObjects.CANVASGRADIENT, ObjectLabel.Kind.OBJECT);
	public static ObjectLabel PATTERN = new ObjectLabel(DOMObjects.CANVASPATTERN, ObjectLabel.Kind.OBJECT);
	public static ObjectLabel PIXEL_ARRAY = new ObjectLabel(DOMObjects.CANVASPIXELARRAY, ObjectLabel.Kind.OBJECT);
	public static ObjectLabel IMAGE_DATA = new ObjectLabel(DOMObjects.IMAGEDATA, ObjectLabel.Kind.OBJECT);
	public static ObjectLabel TEXT_METRICS = new ObjectLabel(DOMObjects.TEXTMETRICS, ObjectLabel.Kind.OBJECT);
	...
	public static Value evaluate(DOMObjects nativeObject, FunctionCalls.CallInfo call, State s, Solver.SolverInterface c) {
		...
		case CANVASRENDERINGCONTEXT2D_SETTRANSFORM: {
			...
			Value m11 = Conversion.toNumber(call.getArg(0), c);
			Value m12 = Conversion.toNumber(call.getArg(1), c);
			Value m21 = Conversion.toNumber(call.getArg(2), c);
		...
		case CANVASRENDERINGCONTEXT2D_CREATE_LINEAR_GRADIENT: {
			...
			Value x0 = Conversion.toNumber(call.getArg(0), c);
		...
		case CANVASRENDERINGCONTEXT2D_CREATE_RADIAL_GRADIENT: {
			...
			Value x0 = Conversion.toNumber(call.getArg(0), c);
			Value y0 = Conversion.toNumber(call.getArg(1), c);
			Value r0 = Conversion.toNumber(call.getArg(2), c);
		...
		case CANVASRENDERINGCONTEXT2D_QUADRATIC_CURVE_TO: {
			NativeFunctions.expectParameters(nativeObject, call, c, 4, 4);
			Value cpx = Conversion.toNumber(call.getArg(0), c);
		...
		case CANVASRENDERINGCONTEXT2D_BEZIER_CURVE_TO: {
			NativeFunctions.expectParameters(nativeObject, call, c, 6, 6);
			Value cp1x = Conversion.toNumber(call.getArg(0), c);
			Value cp1y = Conversion.toNumber(call.getArg(1), c);
			Value cp2x = Conversion.toNumber(call.getArg(2), c);
		...
		case CANVASRENDERINGCONTEXT2D_ARC: {
			...
			Value x = Conversion.toNumber(call.getArg(0), c);
			Value y = Conversion.toNumber(call.getArg(1), c);
			Value radius = Conversion.toNumber(call.getArg(2), c);
		...
		case CANVASRENDERINGCONTEXT2D_ARC_TO: {
			...
			Value x1 = Conversion.toNumber(call.getArg(0), c);
			Value y1 = Conversion.toNumber(call.getArg(1), c);
		...
		case CANVASRENDERINGCONTEXT2D_DRAW_IMAGE: {
			...
			for (ObjectLabel l : call.getArg(0).getObjectLabels()) {
				if (l.isNative()
						&& (l.getNativeObjectID() == DOMObjects.HTMLIMAGEELEMENT || l.getNativeObjectID() == DOMObjects.HTMLCANVASELEMENT)) {
					good = true;
				} else {
					bad = true;
				}
		...
		case CANVASRENDERINGCONTEXT2D_GET_IMAGE_DATA: {
			NativeFunctions.expectParameters(nativeObject, call, c, 4, 4);
			Value sx = Conversion.toNumber(call.getArg(0), c);
