...
public class HTMLBuilder {
	...
	public static void build(State s) {
		...
		// Write documentElement (due to cyclic dependency) and summarize
		// DOMDocument.
		createDOMProperty(s, DOMDocument.INSTANCES, "documentElement",
				Value.makeObject(HTMLHtmlElement.INSTANCES, new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
