...
public class HTMLFrameSetElement {
	...
	public static void build(State s) {
		...
		createDOMProperty(s, DOMWindow.WINDOW, "HTMLFrameSetElement", Value.makeObject(CONSTRUCTOR, new Dependency(), new DependencyGraphReference()));
		 ...
		 */
		// DOM Level 1
		createDOMProperty(s, INSTANCES, "cols", Value.makeAnyStr(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
		createDOMProperty(s, INSTANCES, "rows", Value.makeAnyStr(new Dependency(), new DependencyGraphReference()), DOMSpec.LEVEL_1);
